...
class Events {
   ...
   abstract static class Event {
      ...
      protected final MemcachedOperation op;
      ...
      protected Event(byte version, long messageId, MemcachedOperation op, byte[] listenerId, boolean isRetried, byte marker,
   ...
   static class KeyEvent extends Event {
      ...
      protected KeyEvent(byte version, long messageId, MemcachedOperation op, byte[] listenerId, boolean isRetried,
   ...
   static class KeyWithVersionEvent extends Event {
      ...
      protected KeyWithVersionEvent(byte version, long messageId, MemcachedOperation op, byte[] listenerId, boolean isRetried,
   ...
   static class CustomEvent extends Event {
      ...
      protected CustomEvent(byte version, long messageId, MemcachedOperation op, byte[] listenerId, boolean isRetried,
   ...
   static class CustomRawEvent extends Event {
      ...
      protected CustomRawEvent(byte version, long messageId, MemcachedOperation op, byte[] listenerId, boolean isRetried,
                               byte[] eventData, CompletableFuture<Void> eventFuture) {
