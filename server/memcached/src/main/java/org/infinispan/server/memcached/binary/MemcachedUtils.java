...
class UnknownVersionException extends StreamCorruptedException {
   ...
   public MemcachedHeader toHeader() {
      return new MemcachedHeader(MemcachedOperation.ERROR, version, messageId, "", 0, (short) 1, 0, MediaType.MATCH_ALL, MediaType.MATCH_ALL);
   }
}
