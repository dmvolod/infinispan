...
public enum MemcachedOperation {
   ...
   private static final MemcachedOperation REQUEST_OPCODES[];
   private static final MemcachedOperation RESPONSE_OPCODES[];
   public static final int REQUEST_COUNT;
   static final MemcachedOperation VALUES[] = values();

   MemcachedOperation(int requestOpCode, int responseOpCode, EnumSet<OpReqs> opRequirements, DecoderRequirements decoderRequirements) {
   ...
   MemcachedOperation(int responseOpCode) {
   ...
   static {
      REQUEST_OPCODES = new MemcachedOperation[256];
      RESPONSE_OPCODES = new MemcachedOperation[256];
      int requestCount = 0;
      for(MemcachedOperation op : VALUES) {
   ...
   public static MemcachedOperation fromRequestOpCode(byte op) {
      return REQUEST_OPCODES[op & 0xff];
   }

   public static MemcachedOperation fromResponseOpCode(byte op) {
