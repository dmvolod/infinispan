...
public class AccessLoggingHeader extends MemcachedHeader {
   public final Object principalName;
   public final Object key;
   public final int requestBytes;
   public final Temporal requestStart;

   public AccessLoggingHeader(MemcachedHeader header, Subject subject, Object key, int requestBytes, Temporal requestStart) {
      super(header);
