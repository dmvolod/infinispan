 ...
 * @since 4.1
 */
@Test(groups = "functional", testName = "server.memcached.MemcachedBinaryFunctionalTest")
public class MemcachedBinaryFunctionalTest extends MemcachedBinarySingleNodeTest {
